 ...
 * utiliza.
 * Classe que vai ser responsável por extrair as authorities do token JWT criado pelo Keycloak
 */
@Component
...
public class KeycloakJwtAuthenticationConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    /**
     * É adicionado pra cada role um prefixo ROLE_ e para as roles de determinado resource o prefixo inclui também o nome do resource.
     * @param values
     * @return String
     */
